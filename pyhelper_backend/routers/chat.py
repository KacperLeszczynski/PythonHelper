...
@router.get("/")
async def get_answer(user_query: str, python_version: str = "3.10", num_docs: int = 5, strategy: str = "vector"):
    strategy_enum = ChatModelStrategyEnum(strategy)
    chat_service = ChatCompletionService(strategy_enum, get_summary_buffer_memory())
